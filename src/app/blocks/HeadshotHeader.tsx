...
export function HeadshotHeader() {
  return (
    <header className="bg-cyprus">
      <Container className="flex flex-col items-center gap-4 px-6 pb-6 font-heading text-white sm:grid sm:grid-cols-2 sm:pb-0 lg:gap-20 print:grid-cols-6 print:pb-0">
